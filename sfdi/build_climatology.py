...
VARNAME = {
    ...
    # Wind direction. Used only by the daily Wind-Slope Alignment layer, not
    # by the climatology -- keeping it out of MET_VARS means the 39 years of
    # ERC/BI already on disk stay valid.
...
PHYS = {
    ...
    # Wind direction, degrees the wind blows FROM. Daily layer only.
    "th": (0.0, 360.0),
}
