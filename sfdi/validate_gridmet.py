...
GRIDMET_VARS = {
    ...
    "erc":  ("agg_met_erc_1979_CurrentYear_CONUS.nc", "energy_release_component-g"),
    "bi":   ("agg_met_bi_1979_CurrentYear_CONUS.nc", "burning_index_g"),
}
...
def _read_series(site_name, key):
    """Return (dates, values) from an NCSS CSV point response."""
